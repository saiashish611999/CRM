...
namespace CRM.Domain.Migrations
{
    ...
    [Migration("20250718081019_TIN_CHECK_CONSTRAINT")]
    partial class TIN_CHECK_CONSTRAINT
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM.Domain.Entities.Person", b =>
                {
                    ...
                    b.ToTable("tblPersons", null, t =>
                        {
                            t.HasCheckConstraint("CHK_TIN_Length", "Len([TIN]) = 8");
                        });
